...
//#define GUI_SDRAM_START_ADDRESS   ((uint32_t) 0xD1000000)

#ifdef USE_EXRAM
  #define GUI_NUMBYTES   (20 * 1024 * 1024)    // x KByte
	#define GUI_EXTBUFADD  0xD1000000
//  #define GUI_EXTBUFADD  (0xD2400000-GUI_NUMBYTES*4)
#else
